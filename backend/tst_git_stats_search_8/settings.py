"""
Django settings for tst_git_stats_search_8 project.
...
ROOT_URLCONF = 'tst_git_stats_search_8.urls'
...
WSGI_APPLICATION = 'tst_git_stats_search_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_git_stats_search_8 API",
    "DESCRIPTION": "API documentation for tst_git_stats_search_8 App",
    "VERSION": "v1",
}
